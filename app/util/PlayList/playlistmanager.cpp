...
int PlayListManager::CreatePlayList(const QString &name){
    ...
    int id = musicLib.insertPlayList(playListName);
    playListsInfo.append(PlayListInfo(id, playListName));
    return id;
}
...
PlayListInfo PlayListManager::GetPlayList(const QString &name){
